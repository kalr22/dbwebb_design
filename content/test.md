...
![first](%base_url%/image/movement.jpg?w=500&f=colorize,255,0,0,0)


![second](%base_url%/image/movement.jpg?w=500&f=negate)


![third](%base_url%/image/movement.jpg?w=500&convolve=draw)

![third](%base_url%/image/movement.png?w=500&save-as=jpg)


![first](%base_url%/image/movement.jpg?w=500&f=colorize,255,0,0,0&q=40)


![second](%base_url%/image/movement.jpg?w=500&f=negate&q=20)


![third](%base_url%/image/movement.jpg?w=500&convolve=draw&q=10)

![third](%base_url%/image/movement.png?w=500&save-as=jpg&q=50) -->
